...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./WEB-INF/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="./WEB-INF/js/themes/icon.css" />
    <script type="text/javascript" src="./WEB-INF/js/jquery-1.4.2.min.js"></script>

    <script type="text/javascript" src="./WEB-INF/js/jQuery.easyui.js"></script>
    <%--<script type="text/javascript" src='js/outlook2.js'> </script>--%>
    <script type="text/javascript" src='./WEB-INF/js/outlook2.js'> </script>
